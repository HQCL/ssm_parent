						...
						<div class="pull-left">
							<div class="form-group form-inline">
								<div class="btn-group">
									...
									<button type="button" class="btn btn-default" title="导出" onclick="deleteByIds();">
	...
	<script type="text/javascript">
        function deleteByIds() {
            ...
            if(flag){
                ...
                var b = confirm("是否要导出该日志");
                if(b){
                    location.href = "${pageContext.request.contextPath}/sysLog/deleteById?id="+arr;
                }
            }else {
                alert("没有导入日志信息")
            }
