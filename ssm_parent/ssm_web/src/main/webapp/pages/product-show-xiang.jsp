					...
					<div class="table-box">
						...
						<div class="tab-pane" id="tab-treetable">
							<table id="collapse-table"
								...
								<tr data-tt-id="0">
									<td colspan="7">${product1.productName}</td>
								</tr>

								<tbody>
								<c:forEach items="${product}" var="p" varStatus="vs1">
									...
									<c:forEach items="${p.orders}" var="order" varStatus="vs2">
